...
const prompt = ai.definePrompt({
  ...
  Your task is to generate the code for a single React component that serves as a landing page for a new cryptocurrency project.
  ...
  **Instructions:**
  ...
  2.  **Structure:** Create a standard landing page structure:
      *   A navigation bar.
      *   A hero section highlighting the mission.
      *   A "Key Features" section.
      *   A "Token Utility" section.
      *   A "Call to Action" section to join the community or read the whitepaper.
      *   A simple footer.
  3.  **Content:** Use the provided parameters to populate the content of the page. The tone should be professional and exciting.
  4.  **Styling:**
  ...
  5.  **Code Format:**
      ...
      *   The component should accept a \`logoUrl: string\` prop to display the project's logo.
